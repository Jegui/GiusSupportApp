...
class ConsoleViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    peripheralLabel.text = BlePeripheral.connectedPeripheral?.name
      ...
      txLabel.text = "TX:\(String(describing: BlePeripheral.connectedTXChar?.uuid.uuidString))"
      rxLabel.text = "RX:\(String(describing: BlePeripheral.connectedRXChar?.uuid.uuidString))"
